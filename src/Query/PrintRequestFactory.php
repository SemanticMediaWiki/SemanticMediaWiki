...
class PrintRequestFactory {
	 ...
	 */
	public function newFromText( $text, $showMode = false, $asCanonicalLabel = false, ?array $params = null ) {
		return PrintRequest::newFromText( $text, $showMode, $asCanonicalLabel, $params );
	}
