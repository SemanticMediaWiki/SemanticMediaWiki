...
abstract class ResultPrinter implements IResultPrinter {
	...
	/**
	 * Gets a Infolink object that allows linking to a display of the query result.
	 *
	 * @since 1.8
	 *
	...
	/**
	 * Gets a Infolink object that allows linking to further results for the query.
	 *
	 * @since 1.8
	 *
	 * @param QueryResult $res
