...
protected $m_ContentMessages = array(
	...
	'smw_emtpysubquery' => '某些子查询并不具备有效的查询条件', //'Some subquery has no valid condition.'
...
protected $m_UserMessages = array(
	...
	'smw_propertyspecial' => '在此wiki内，这是一项特殊的性质有着保留的意义。',      //'This is a special property with a reserved meaning in the wiki.',
	...
	'smw_ask_docu' => '<p>依下方的搜寻栏位内所键入的查询值进行搜寻，进一步的信息位于<a href="$1">语意搜自导引求助页面</a>.</p>',    //'<p>Search by entering a query into the search field below. Further information is given on the <a href="$1">help page for semantic search</a>.</p>',
...
protected $m_SpecialProperties = array(
	...
	SMW_SP_DISPLAY_UNIT => '显示单位',      //Display unit
