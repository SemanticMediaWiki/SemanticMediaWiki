...
$messages['be-tarask'] = array(
	...
	'smw_paramdesc_headers' => 'Ці паказваць назвы загалоўкаў/уласьцівасьцяў',
	'smw_paramdesc_mainlabel' => 'Метка для назвы галоўнай старонкі',
	'smw_paramdesc_link' => 'Ці паказваць значэньні як спасылкі',
	...
	'smw_paramdesc_columns' => 'Колькасьць слупкоў у якіх будуць паказвацца вынікі (па змоўчваньні — 3)',
...
Si el problema persisteix passat cert temps, demana a l'administrador del teu wiki que posi disponible aquest concepte.",
	...
	'smw_unknown_importns' => 'Les funcions d\'importació no estan disponibles per l\'espai de noms "$1".',
	'smw_nonright_importtype' => '$1 només es pot utilitzar per pàgines en l\'espai de noms "$2".',
	'smw_wrong_importtype' => '$1 no és pot fer servir per pàgines en l\'espai de noms "$2".',
	...
	'smw_unknowntype' => 'S\'ha definit un tipus "$1" no suportat per la propietat.',
	...
	'smw_lonely_unit' => 'No s\'ha trobat cap nombre davant el símbol "$1".',
	'smw_bad_latlong' => 'La latitud i la longitud només es poden donar un sol cop, i amb coordenades vàlides.',
	'smw_abb_north' => 'N',
	'smw_abb_east' => 'E',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'O',
...
Fes un bolcat de les teves dades (''backup'') abans de fer-la servir.",
...
$messages['el'] = array(
	...
	'smw_ask_printhead' => 'Πρόσθετα αντίγραφα (προαιρετικό)',
...
Si el problema persiste después de pasado algún tiempo, solicita al administrador de tu sitio que haga este concepto disponible.',
	...
	'smw_bad_latlong' => 'Latitud y longitud solamente pueden darse una sola vez, y con valores de coordenadas válidas.',
	'smw_abb_north' => 'N',
	'smw_abb_east' => 'E',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'O',
...
$messages['fr'] = array(
	...
	'smw_paramdesc_headers' => "S'il faut ou non afficher les en-têtes / noms des propriétés",
	'smw_paramdesc_mainlabel' => "Le label qui donne le nom de la page d'accueil",
	'smw_paramdesc_link' => "S'il faut ou non afficher les valeurs en tant que liens",
...
$messages['gl'] = array(
	...
	'smw_paramdesc_headers' => 'Mostrar ou non as cabeceiras/os nomes de propiedade',
	'smw_paramdesc_mainlabel' => 'A lapela para dar nome á páxina principal',
	'smw_paramdesc_link' => 'Mostrar ou non os valores como ligazóns',
...
Wänn s Probläm imfall noch eme Rung nit verschwindet, no bitt Dyy Syteverwalter, des Konzäpt megli z mache.',
	...
	'smw_paramdesc_headers' => 'Eb d Nämme vu dr Eigeschafte solle aazeigt wäre oder nit',
	'smw_paramdesc_mainlabel' => 'S Label vu Hauptsytename',
	'smw_paramdesc_link' => 'Eb Wärt as Gleicher (Links) solle aazeigt wäre oder nit',
	...
	'smw_paramdesc_columns' => 'D Aazahl vu dr Spalte go Ergebnis aazeige (Standard isch 3)',
...
Jeli so problem po wěstym času njezhubi, woprašej so sydłoweho administratora, zo by wón tutón koncept k dispoziciji stajił.',
	...
	'smw_paramdesc_headers' => 'Mjena hłowow abo atributow zwobraznić abo nic',
	'smw_paramdesc_mainlabel' => 'Pomjenowanje, kotrež ma so hłownej stronje dać',
	'smw_paramdesc_link' => 'Hódnoty jako wotkazy pokazać abo nic',
	...
	'smw_paramdesc_columns' => 'Ličba špaltow, w kotrychž maja so wuslědki zwobraznić (standard je 3)',
...
Ha a probléma nem szűnik meg bizonyos idő elteltével, kérd az oldal adminisztrátorát hogy tegye elérhetővé a koncepciót.',
	...
	'smw_paramdesc_headers' => 'Fejlécek/tulajdonságnevek megjelenítése, vagy sem',
	'smw_paramdesc_link' => 'Az értékek hivatkozásként jelenjenek meg, vagy sem',
	...
	'smw_paramdesc_columns' => 'A keresési eredmények oszlopainak száma (az alapértelmezett 3)',
	...
	'smw_bad_latlong' => 'A földrajzi szélességet és hosszúságot csak egyszer kell megadni, érvényes koordinátákkal.',
	'smw_abb_north' => 'É',
	'smw_abb_east' => 'K',
	'smw_abb_south' => 'D',
	'smw_abb_west' => 'Ny',
...
$messages['ia'] = array(
	...
	'smw_paramdesc_headers' => 'Si o non monstrar le capites/nomines de proprietate',
	'smw_paramdesc_mainlabel' => 'Le etiquetta a dar al nomine del pagina principal',
	'smw_paramdesc_link' => 'Si o non monstrar valores como ligamines',
	...
	'smw_paramdesc_columns' => 'Le numero de columnas in le quales presentar resultatos (predefinition es 3)',
...
Jika masalah ini tidak hilang setelah beberapa waktu, mintalah pengelola situs untuk membuat konsep ini tersedia.',
	...
	'smw_paramdesc_columns' => 'Jumlah kolom untuk menampilkan hasil (bawaannya adalah 3)',
	...
	'smw_lonely_unit' => 'Tidak ada angka yang ditemukan sebelum simbol "$1".',
	'smw_bad_latlong' => 'Garis lintang dan bujur harus diberikan hanya sekali, dan dengan koordinat yang valid.',
	'smw_abb_north' => 'U',
	'smw_abb_east' => 'T',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'B',
...
Ini memastikan bahwa manusia tidak berubah menjadi situs web.',
	...
	'smw_ask_queryhead' => 'Query',
	'smw_ask_printhead' => 'Keluaran tambahan (opsional)',
...
$messages['ja'] = array(
	...
	'smw_paramdesc_headers' => 'ヘッダーやプロパティーの名前を表示するかどうか',
	'smw_paramdesc_mainlabel' => 'メインページの名前に与えるラベル',
	'smw_paramdesc_link' => '値をリンクとして表示するかどうか',
...
Aanforderung dorschjeiht, dann froch Dinge Wiki-Köbes donoh, noh dämm Kunzäp.',
	...
	'smw_paramdesc_headers' => 'Ov mer de Köpp oder de Name vun Eijeschaffte aanzeije well, udder nit',
	'smw_paramdesc_link' => 'Ov mer de Wääte als Lengks aanzeije well, udder nit',
...
$messages['lb'] = array(
	...
	'smw_paramdesc_link' => "Ob d'Werter als Linken gewise ginn oder net",
	...
	'smw_unsupportedunit' => 'Umrechnung vun der Eenheet "$1" gëtt net ënnerstetzt.',
...
Als het probleem over enige tijd nog niet verholpen is, vraag de beheerder dan om dit concept beschikbaar te maken.',
	...
	'smw_paramdesc_headers' => 'Wel of niet de namen van de eigenschappen weergeven',
	'smw_paramdesc_mainlabel' => 'Het label voor de hoofdpaginanaam',
	'smw_paramdesc_link' => 'Wel of niet waarden als verwijzingen weergeven',
	...
	'smw_paramdesc_columns' => 'Het aantal kolommen om resultaten in weer te geven (standaard 3)',
...
$messages['pl'] = array(
	...
	'smw_bad_latlong' => 'Szerokość i długość geograficzna muszą być podane raz, z prawidłowymi współrzędnymi.',
	'smw_abb_north' => 'N',
	'smw_abb_east' => 'E',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'W',
...
$messages['pt'] = array(
	...
	'smw_paramdesc_limit' => 'O número máximo de resultados a devolver',
	'smw_paramdesc_headers' => 'Apresentar, ou não, os nomes dos cabeçalhos e propriedades',
	'smw_paramdesc_mainlabel' => 'A etiqueta a atribuir ao nome da página principal',
	'smw_paramdesc_link' => 'Apresentar, ou não, os valores como ligações',
	...
	'smw_paramdesc_columns' => 'O número de colunas em que os resultados serão apresentados (por omissão, 3)',
...
$messages['ro'] = array(
	...
	'smw_lonely_unit' => 'Nici un număr găsit înaintea simbolului "$1".',
	'smw_bad_latlong' => 'Latitudinea şi longitutdinea trebuie date o singură dată, şi cu valori valide.',
	'smw_abb_north' => 'N',
	'smw_abb_east' => 'E',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'V',
	...
	'smw_unexpectedpart' => 'Partea "$1" a interogării nu a fost înţeleasă.
Rezultatele pot fi neaşteptate.',
	...
	'smw_subpropertyarticlecount' => 'Această proprietate are {{PLURAL:$1|următoarea subproprietate|următoarele $1 subproprietăţi}}:',
	...
	'smw_ask_sortby' => 'Sortare după coloană (opţional)',
...
$messages['ru'] = array(
	...
	'smw_paramdesc_headers' => 'Будет ли показываться заголовки/названия свойств',
	'smw_paramdesc_mainlabel' => 'Обозначение, даваемое названию главной страницы',
	'smw_paramdesc_link' => 'Будут ли отображаются значения как ссылки',
	...
	'smw_paramdesc_columns' => 'Количество столбцов для вывода результатов поиска (по умолчанию 3)',
