...
If the problem does not go away after some time, ask your site administrator to make this concept available.',
	...
	'smw-paramdesc-searchlabel'	=> 'The text for the link to results',
...
{{Identical|And}}',
	...
	'smw-paramdesc-intro' => 'A description of the "intro" parameter for inline queries',
	'smw-paramdesc-outro' => 'A description of the "outro" parameter for inline queries',
	'smw-paramdesc-default' => 'A description of the "default" parameter for inline queries',
...
$messages['be-tarask'] = array(
	...
	'smw-paramdesc-searchlabel' => 'Тэкст для спасылкі на вынікі',
...
$messages['br'] = array(
	...
	'smw-paramdesc-template' => 'An ar patrom gant pehini eo ret diskouez ar moulladurioù',
	'smw-paramdesc-columns' => "An niver a golonennoù evit pere ez eus da ziskouez an disoc'hoù ($1 dre ziouer)",
	'smw-paramdesc-userparam' => "Un talvoudenn tremenet e pep galvadenn a batrom, ma 'z eo implijet ur patrom",
	...
	'smw-paramdesc-embedformat' => 'Ar balizenn HTML hag a servij da dermeniñ an talbennoù',
...
Si el problema persisteix passat cert temps, demaneu a l'administrador del vostre wiki que posi disponible aquest concepte.",
	...
	'smw-paramdesc-searchlabel' => "El text de l'enllaç als resultats",
...
Falls sich das Problem nicht in angemessener Zeit von selbst erledigt, bitte deinen Websiteadministrator, die Daten dieses Konzepts zu aktualisieren.',
	...
	'smw-paramdesc-searchlabel' => 'Der Text für den Link zu den Ergebnissen',
	...
	'smw-paramdesc-template' => 'Der Name einer Vorlage zum Anzeigen der Abfrageergebnisse',
	...
	'smw-paramdesc-embedformat' => 'Das für die Festlegung der Überschriften genutzte HTML-Tag',
	...
	'smw-paramdesc-rdfsyntax' => 'Zu verwendende RDF-Syntax',
...
Jolic problem se njezgubujo pó wěstem casu, pšos swójogo sedłowego administratora, aby wón toś ten koncept k dispoziciji stajił.',
	...
	'smw-paramdesc-searchlabel' => 'Tekst za wótkaz do wuslědkow',
	...
	'smw-paramdesc-rsstitle' => 'Tekst, kótaryž ma se ako titel kanala wužywaś',
	'smw-paramdesc-rssdescription' => 'Tekst, kótaryž ma se ako wopisanje kanala wužywaś',
...
Si el problema persiste después de pasado algún tiempo, solicita al administrador de tu sitio que haga este concepto disponible.',
	...
	'smw-paramdesc-searchlabel' => 'El texto para el enlace a los resultados',
	...
	'smw-paramdesc-rsstitle' => 'Texto a ser usado como título del canal',
	'smw-paramdesc-rssdescription' => 'Texto a ser usado como descripción del canal',
...
$messages['fr'] = array(
	...
	'smw-paramdesc-searchlabel' => 'Le texte du lien vers les résultats',
...
$messages['gl'] = array(
	...
	'smw-paramdesc-searchlabel' => 'O texto na ligazón aos resultados',
...
Jeli so problem po wěstym času njezhubi, woprašej so sydłoweho administratora, zo by wón tutón koncept k dispoziciji stajił.',
	...
	'smw-paramdesc-searchlabel' => 'Tekst wotkaza k wuslědkam',
...
$messages['ia'] = array(
	...
	'smw-paramdesc-searchlabel' => 'Le texto pro le ligamine verso le resultatos',
...
$messages['ja'] = array(
	...
	'smw-paramdesc-mainlabel' => 'メインページの名前に与えるラベル',
	'smw-paramdesc-link' => '値をリンクとして表示する',
	'smw-paramdesc-intro' => '問い合わせ結果がある場合、その前に表示する文章',
	'smw-paramdesc-outro' => '問い合わせ結果がある場合、その後に表示する文章',
	'smw-paramdesc-default' => '問い合わせ結果がない場合に表示する文章',
	'smw-paramdesc-searchlabel' => '結果へのリンクの文字列',
	'smw-paramdesc-sep' => '値の区切り記号',
	'smw-paramdesc-template' => '印刷出力とともに表示するテンプレートの名前',
	'smw-paramdesc-columns' => '結果を表示する列の数 (既定は3)',
	...
	'smw-paramdesc-embedformat' => '見出しを定義するための HTML タグ',
	'smw-paramdesc-embedonly' => '見出しを表示しない',
	'smw-paramdesc-table-class' => 'テーブルに設定する追加の CSS クラス',
	'smw-paramdesc-rsstitle' => 'フィードの表題として使う文字列',
	'smw-paramdesc-rssdescription' => 'フィードの説明文として使う文字列',
	'smw-paramdesc-rdfsyntax' => '使用するRDF構文',
...
Ако проблемот не исчезне по извесно време, побарајте од вашиот администратор да го овозможи тој концепт.',
	...
	'smw-paramdesc-searchlabel' => 'Текстот на врската кон резултатите',
	...
	'smw-paramdesc-columns' => 'Бројот на колони за приказ на резултати (3 по основно)',
...
Hvis problemet ikke forsvinner etter en periode, spør sidens administratorer om å gjøre konseptet tilgjengelig.',
	...
	'smw-paramdesc-searchlabel' => 'Tekst for resultatlenken',
...
Als het probleem over enige tijd nog niet verholpen is, vraag de beheerder dan om dit concept beschikbaar te maken.',
	...
	'smw-paramdesc-searchlabel' => 'De tekst voor de verwijzing naar resultaten',
...
$messages['pl'] = array(
	...
	'smw-paramdesc-searchlabel' => 'Treść linku do wyników',
...
Caso o problema não seja resolvido automaticamente dentro de algum tempo, peça a um administrador deste wiki que este conceito seja disponibilizado.',
	...
	'smw-paramdesc-searchlabel' => 'Texto do link para os resultados',
	'smw-paramdesc-sep' => 'Separador de valores',
	...
	'smw-paramdesc-rsstitle' => 'Texto a ser utilizado como título do feed',
	'smw-paramdesc-rssdescription' => 'Texto a ser utilizado como descrição do feed',
...
$messages['uk'] = array(
	...
	'smw-paramdesc-limit' => 'Максимальна кількість результатів',
...
如果这个问题在一段时间后仍未解决，请向网站管理员请求令该概念可用。',
	...
	'smw-paramdesc-searchlabel' => '在指向结果的链接中显示的文字',
