...
Dic'hortoz e c'hall bezañ an disoc'hoù.",
	...
	'smw_unusedproperty_template' => '$1 eus an doare $2',
	...
	'pageproperty' => "Klask e perc'hennedigezh ar bajenn",
...
Не заборавајте да направите резервни копии од значајни податоци пред да вршите административни постапки.',
	...
	'smw_smwadmin_dbdocu' => 'Semantic MediaWiki бара додавање на извесни проширувања кон MediaWiki базата на податоци за да складира семантички податоци.
Функцијата подолу ви гарантира дека вшата база на податоци е правилно поставена.
Промените извршени во овој чекор немаат влијание врз остатокот од MediaWiki базата на податоци, и лесно можат да се вратат по старо ако се јави потреба.
...
$messages['ml'] = array(
	...
	'smw_unknown_importns' => 'ഇറക്കുമതി ഫങ്ങ്ഷന്‍സ് “$1” എന്ന നാമമേഖലയില്‍ ലഭ്യമല്ല.',
	'smw_nonright_importtype' => '“$2” എന്ന നാമമേഖലയിലുള്ള താളുകളില്‍ മാത്രമേ $1 ഉപയോഗിക്കാന്‍ പറ്റൂ.',
	'smw_wrong_importtype' => '“$2” എന്ന നാമമേഖലയിലുള്ള താളുകളില്‍ $1 ഉപയോഗിക്കുവാന്‍ പറ്റില്ല.',
...
Se ël problema a van nen via an chèich moment, ciamé a l'aministrator ëd sò sit ëd rende 's concet disponìbil.",
	...
	'smw_paramdesc_headers' => 'Mosta ij nòm ëd le testà/proprietà',
	'smw_paramdesc_mainlabel' => "L'etichëtta da dé al nòm ëd la pàgina prinsipal",
	'smw_paramdesc_link' => 'Mosta valor com colegament',
	'smw_paramdesc_intro' => "Ël test da mosté prima dj'arzultà dla query, s'a-i në son",
	'smw_paramdesc_outro' => "Ël test da mosté d'apress dj'arzultà dla query, s'a-i në son",
	'smw_paramdesc_default' => "Ël test da mosté s'a-i é pa gnun arzultà dle query",
	...
	'smw_paramdesc_columns' => "Ël nùmer ëd colòne andoa mosté j'arzultà (ël default a l'é $1)",
	'smw_paramdesc_embedformat' => "L'etichëtta HTML dovrà për definì le testà",
	'smw_paramdesc_embedonly' => 'Mosta pa gnun-e testà',
	'smw_paramdesc_rsstitle' => 'Ël test da mosté com ël tìtol dël feed',
	'smw_paramdesc_rssdescription' => 'Ël test da dovré com la descrission dël feed',
	'smw_iq_disabled' => 'Le query semàntiche a son ëstàite disabilità për sta wiki-sì.',
	'smw_iq_moreresults' => '... àutri arzultà',
	'smw_iq_nojs' => 'Dòvra un browser abilità a JavaScript për vëdde sto element-sì.',
	...
	'smw_nonright_importtype' => "$1 a peul esse mach dovrà për pàgine con spassi nominal ''$2''.",
	'smw_wrong_importtype' => "$1 a peul pa esse dovrà për pàgine ant lë spassi nominal ''$2''.",
	'smw_no_importelement' => "L'element ''$1'' a l'é pa disponìbil për amporté.",
	'smw_parseerror' => "Ël valor dàit a l'é pa capì.",
	'smw_notitle' => "''$1'' a peul pa esse dovrà com nòm ëd pàgina an sta wiki-sì.",
	'smw_wrong_namespace' => "mach pàgine ant lë spassi nominal ''$1'' a son possìbij ambelessì.",
	'smw_unknowntype' => "Un tipo ''$1'' pa apogià a l'é definì për proprietà.",
	...
	'smw_noboolean' => "''$1'' a l'é pa arconossù con un valor Boolean (ver/fàuss).",
	'smw_true_words' => 'ver,v,é!,é',
	'smw_false_words' => 'fàuss,f,nò,n',
	'smw_nofloat' => "''$1'' a l'é pa un nùmer",
	'smw_infinite' => "Nùmer gross com ''$1'' a son pa apogià.",
	'smw_infinite_unit' => "La convërsion ant l'ùnità ''$1'' a dà com arzultà un nùmer che a l'é tròp gròss.",
	'smw_novalues' => 'Pa gnun valor specificà.',
	'smw_unsupportedprefix' => "Ij prefiss për nùmer (''$1'') a son pa apogià.",
	'smw_unsupportedunit' => "La conversion ëd misura për l'unità ''$1'' a l'é pa apogià.",
	'smw_nodatetime' => "La data ''$1'' a l'é pa stàita capìa.",
	'smw_toomanyclosing' => "A smija ch'a-i sia tròpe ocorense ëd ''$1'' ant la query.",
	'smw_noclosingbrackets' => 'Cheich usagi ëd "<nowiki>[[</nowiki>" an toa query a son pa stàit sarà da un corëspondent "]]".',
	'smw_misplacedsymbol' => 'Ël sìmbol "$1" a l\'era dovrà ant un pòst andoa a l\'é pa ùtil.',
	'smw_unexpectedpart' => 'La part "$1" ëd la query a l\'é pa stàita capìa.
J\'arzultà a peulo esse pa com spetà.',
	'smw_emptysubquery' => "Cheich subquery a l'ha ëd condission pa bon-e.",
	'smw_misplacedsubquery' => "Cheich subquery a l'era dovrà ant un pòst andoa pa gnun-e subquery a l'ero përmëttùe.",
	'smw_valuesubquery' => 'Subquery pa apogià për ij valor ëd la proprietà "$1".',
	'smw_overprintoutlimit' => "La query a conten tròpe arceste d'arzultà.",
	'smw_badprintout' => "Cheich istrussion dë stampa ant la quesry a l'era malformà.",
	'smw_badtitle' => '"$1" a l\'é un tìtol ëd pàgina pa bon.',
	'smw_badqueryatom' => 'Cheich part "<nowiki>[[…]]</nowiki>" ëd la query a l\'é pa stàita capìa.',
	'smw_propvalueproblem' => 'Ël valor ëd la proprietà "$1" a l\'é pa stàit capì.',
	'smw_noqueryfeature' => "Cheich funsion ëd la query a l'é pa apogià an sta wiki-sì e part ëd la query a l'é stàita sautà ($1).",
	'smw_noconjunctions' => "Le congiunsion ant le query a son pa apogià an sta wiki-sì e part ëd la query a l'é stàita sautà ($1).",
	'smw_nodisjunctions' => "Le disgiunsion ant le query a son pa apogià an sta wiki-sì e part ëd la query a l'é stàita sautà ($1).",
	'smw_querytoolarge' => 'Le condission ëd query sota a dovrìo pa esse considerà dovùe a le restrission ëd la wiki ant la dimension o profondità dla quuery: $1.',
	'smw_devel_warning' => "Sta funsion-sì a l'é al moment sota dësvilup, e a podrìe esse pa completament funsionanta.
Salva ij tò dat prima ëd dovrela.",
	'smw_notemplategiven' => 'Dà un valor për ël paràmetr "stamp" an manera che sto formà-sì ëd query a travaja.',
	'smw_type_header' => 'Proprietà dël tipo "$1".',
	'smw_typearticlecount' => "Mosté $1 {{PLURAL:$1|proprietà|proprietà}} ch'a dòvro sto tipo-sì.",
	'smw_attribute_header' => 'Pàgine ch\'a dòvro la proprietà "$1".',
	'smw_attributearticlecount' => "Mosté $1 {{PLURAL:$1|pàgine|pàgine}} ch'a dòvro sta proprietà-sì.",
	'smw_subproperty_header' => 'Sotproprietà',
	'smw_subpropertyarticlecount' => "Sta proprietà-sì a l'ha le $1 {{PLURAL:$1|sotproprietà|sotproprietà}} sota:",
	'smw_concept_header' => 'Pàgine dël concet "$1"',
	'smw_conceptarticlecount' => 'Mosté $1 {{PLURAL:$1|pàgina|pàgine}} che a aparten-o a col concet.',
	'exportrdf' => 'Espòrta pàgine an RDF',
	'smw_exportrdf_docu' => "Sta pàgina-sì at përmëtt d'oten-e dat da na pàgina an formà RDF.
Për esporté pàgine, ansëriss ij tìtoj ant la textbox sota, un tìtol për linia.",
	'smw_exportrdf_recursive' => "Espòrta recorsivament tute le pàgine corelà.
Nòta che l'arzultà a podrìe esse gròss!",
	'smw_exportrdf_backlinks' => "Espòrta ëdcò tute le pàgine ch'a s'arfërisso a le pàgine esportà.
A genera RDF navigàbij.",
...
Rezultatele pot fi neaşteptate.',
	...
	'browse' => 'Răsfoiţi wiki',
	'smw_browselink' => 'Răsfoiţi proprietăţile',
	'smw_browse_go' => 'Mergi',
