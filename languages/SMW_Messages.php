...
ייתכן שהתוצאות לא יתאימו למצופה.',
	...
	'smw_querytoolarge' => 'לא ניתן להתחשב בתנאי השאילתה הבאה עקב מגבלות אתרי הוויקי בגודל השאילתה או בעומקה: $1.',
	'smw_devel_warning' => 'תכונה זו נמצאת כעת בפיתוח, ויתכן שאינה פעילה באופן מלא.
גבו את הנתונים שלכם בטרם השימוש בתכונה.',
	'smw_notemplategiven' => 'ציינו ערך עבור הפרמטר "template" כדי שמבנה שאילתה זו יעבוד.',
	'smw_type_header' => 'מאפיינים מסוג "$1"',
	'smw_typearticlecount' => 'הצגת {{PLURAL:$1|מאפיין $1 המשתמש|$1 מאפיינים המשתמשים}} בסוג זה.',
	'smw_attribute_header' => 'דפים המשתמשים במאפיין "$1"',
	'smw_attributearticlecount' => 'הצגת {{PLURAL:$1|דף $1 המשתמש|$1 דפים המשתמשים}} במאפיין זה.',
	'smw_subproperty_header' => 'תת־מאפיינים',
	'exportrdf' => 'ייצוא דפים ל־RDF',
	'smw_exportrdf_recursive' => 'ייצוא נסוג של כל הדפים הקשורים.
שימו לב שהתוצאה עלולה להיות גדולה!',
	...
	'smw_oi_select' => 'בחרו את ההצהרות לייבוא, ואז לחצו על לחצן הייבוא.',
	'smw_oi_textforall' => 'טקסט כותרת להוספה לכל הנתונים המיובאים (יכול להשאר ריק):',
	'smw_oi_selectall' => 'בחרו או בטלו את בחירת כל ההצהרות',
	'smw_oi_statementsabout' => 'הצהרות אודות',
	'smw_oi_comment' => 'הוספת הטקסט הבא:',
	'smw_oi_thisissubcategoryof' => 'תת־קטגוריה של',
	...
	'smw_ask_editquery' => '[עריכת שאילתה]',
	'smw_add_sortcondition' => '[הוספת תנאי לסידור]',
	'smw_ask_hidequery' => 'הסתרת השאילתה',
	'smw_ask_help' => 'עזרה בהצבת שאילתות',
	'smw_ask_queryhead' => 'שאילתה',
	'searchbyproperty' => 'חיפוש לפי מאפיין',
	'smw_sbv_docu' => '<p>חיפוש אחר כל הדפים להם ניתן מאפיין וערך.</p>',
	'smw_sbv_noproperty' => '<p>הזינו מאפיין.</p>',
	'smw_sbv_novalue' => '<p>הזינו ערך תקין למאפיין, או עיינו בכל ערכי המאפיינים עבור "$1".</p>',
	'smw_sbv_displayresult' => 'רשימת כל הדפים להם יש את המאפיין "$1" עם הערך "$2"',
	'smw_sbv_displayresultfuzzy' => 'רשימת כל הדפים להם יש את המאפיין "$1" עם הערך "$2".
מאחר שישנן רק מעט תוצאות, יוצגו גם ערכים סמוכים.',
