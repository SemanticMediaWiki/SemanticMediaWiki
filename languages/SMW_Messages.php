...
Увядзіце назвы старонкі і ўласьцівасьці.',
	...
	'smw_smwadmin_settingup' => 'Налады сховішча Semantic MediaWiki',
...
Falls sich das Problem nicht in angemessener Zeit von selbst erledigt, bitte deinen Websiteadministrator, die Daten dieses Konzepts zu aktualisieren.',
	...
	'smw_overprintoutlimit' => 'Die Abfrage enthält zu viele Ausgabeanweisungen.',
	...
	'tooltip-purge' => 'Hier klicken um die Abfrageergebnisse und Vorlagen auf dieser Seite auf den neuesten Stand zu bringen.',
	'smw_purge' => 'Neu laden',
	'types' => 'Datentypen',
...
$messages['frp'] = array(
	...
	'smw_badtitle' => '« $1 » est pas un titro de pâge valido.',
...
$messages['he'] = array(
	...
	'smw_edithelp' => 'עזרה בנושא עריכת מאפיינים',
...
ייתכן שהתוצאות לא יתאימו למצופה.',
	...
	'smw_overprintoutlimit' => 'השאילתה מכילה בקשות תדפיס רבות מדי.',
	'smw_badprintout' => 'מספר פקודות תדפיס בשאילתה אינן תקניות.',
...
ייווצר RDF הניתן לעיון.',
	...
	'types' => 'טיפוסים',
	'smw_types_docu' => 'ברשימה זו מופיעים כל סוגי הנתונים שיכולים להיות מושמים למאפיינים. לכל סוג נתונים יש דף המסביר על אודותיו.',
...
$messages['hr'] = array(
	...
	'smw_edithelp' => 'Pomoć o uređivanju svojstava',
	'smw_viewasrdf' => 'RDF feed',
	'smw_finallistconjunct' => ', i',
	'smw_factbox_head' => 'Činjenice o $1',
	...
	'smw_iq_nojs' => 'Koristite preglednik s JavaScriptom kako biste vidjeli ovaj element.',
	'smw_iq_altresults' => 'Izravno pregledajte popis rezultata.',
	'smw_unknown_importns' => 'Funkcije za uvoz nisu dostupne u imenskom prostoru "$1".',
	...
	'smw_infinite_unit' => 'Rezultat pretvorbe u jedinicu "$1" je prevelik broj.',
...
Rezultati možda neće biti odgovarajući.',
	...
	'smw_overprintoutlimit' => 'Upit sadrži previše zahtjeva za ispisom.',
	'smw_badprintout' => 'Neka od naredbi za ispis u upitu sadrži pogrešku..',
	'smw_badtitle' => '"$1" nije valjani naslov stranice.',
	...
	'smw_devel_warning' => 'Ova osobina je trenutno u razvoju i moguće je da još u potpunosti ne funkcionira.
Prije korištenja napravite kopiju svojih podataka.',
 ...
 */
$messages['ht'] = array(
	'smw_edithelp' => 'Èd pou modifikasyon pwopryete yo',
	...
	'smw_iq_altresults' => 'Gade lis rezilta yo dirèkteman.',
	...
	'smw_infinite_unit' => 'Konvèsyon nan inite "$1" bay yon nimewo ki twò gwo.',
	'smw_unsupportedprefix' => 'Prefiks pou nimewo ("$1") yo pa sipòte.',
);
...
Ta en kopi av egne data før du bruker den.',
...
Se ël problema a van nen via an chèich moment, ciamé a l'aministrator ëd sò sit ëd rende 's concet disponìbil.",
	...
	'smw_unitnotallowed' => '"$1" a l\'é pa diciarà com n\'unità ëd misura bon-a për sta proprietà.',
 ...
 */
$messages['pt'] = array(
	'smw-desc' => "Tornar a sua wiki mais acessível - para máquinas ''e'' para seres humanos ([http://semantic-mediawiki.org/wiki/Help:User_manual documentação ''online''])",
	...
	'smw_iq_nojs' => 'Para ver este elemento, use um browser com o JavaScript activado.',
	'smw_iq_altresults' => 'Navegar directamente pela lista de resultados.',
	...
	'smw_unsupportedprefix' => 'Prefixos para números (“$1”) não são suportados.',
...
Os resultados poderão não ser os esperados.',
	...
	'smw_overprintoutlimit' => 'Esta consulta contém demasiados pedidos de impressão.',
	'smw_badprintout' => 'Uma frase de saída na consulta estava mal formada.',
	'smw_badtitle' => '“$1” não é um título de página válido.',
	...
	'smw_devel_warning' => 'Esta funcionalidade está neste momento em desenvolvimento, e pode não estar totalmente operacional.
Faça uma cópia de segurança dos dados antes de usá-la.',
...
Gera um RDF navegável.',
	...
	'smw_wantedproperty_template' => '$1 ($2 {{PLURAL:$2|uso|usos}})',
	'tooltip-purge' => 'Carregue aqui para refrescar todas as consultas e predefinições nesta página',
	'smw_purge' => 'Refrescar',
	'types' => 'Tipos',
...
Introduza a página e a propriedade.',
	...
	'smw_smwadmin_settingup' => 'A configurar o armazenamento para o MediaWiki Semântico',
...
$messages['pt-br'] = array(
	...
	'smw_isnotype' => 'O tipo "$1" não é um dos tipos de dados padrão da wiki, nem lhe foi dada uma definição de usuário.',
	'smw_concept_description' => 'Descrição do conceito "$1"',
...
$messages['uk'] = array(
	...
	'smw_iq_nojs' => 'Для перегляду цього елемента потрібен переглядач з підтримкою JavaScript.',
	'smw_iq_altresults' => 'Оглянути список результатів безпосередньо.',
	'smw_unknown_importns' => 'Функції імпорту недоступні для простору назв «$1».',
	...
	'smw_infinite_unit' => 'Конвертація в одиницю «$1» видала занадто довге число.',
	'smw_novalues' => 'Не вказано значень.',
	'smw_unsupportedprefix' => 'Префікси для чисел («$1») не підтримуються.',
	...
	'smw_overprintoutlimit' => 'Запит містить занадто багато позицій виводу.',
	'smw_badprintout' => 'Деякі формулювання виводу в запиті були неправильно складені.',
	'smw_badtitle' => '«$1» не є правильним заголовком сторінки.',
	...
	'smw_devel_warning' => 'Ця функція перебуває в стані розроби, тому може не бути повністю функціонально. Зробіть резервну копію даних перед її використанням.',
	...
	'tooltip-purge' => 'Клацніть сюди, щоб освіжити всі запити та шаблони на цій сторінці',
	'smw_purge' => 'Оновити',
	'types' => 'Типи',
	...
	'smw_smwadmin_settingup' => 'Приготування бази даних для Semantic MediaWiki',
...
如果这个问题在一段时间后仍未解决，请向网站管理员请求令该概念可用。',
	...
	'smw_iq_disabled' => '此维基的语义查询已被禁用',
	'smw_iq_moreresults' => '更多结果',
	'smw_iq_nojs' => '使用允许JavaScript的浏览器显示此元素',
	'smw_iq_altresults' => '直接浏览结果列表。',
	'smw_unknown_importns' => '命名空间"$1"不允许导入函数。',
	'smw_nonright_importtype' => '$1只可用于命名空间"$2"下的页面。',
	'smw_wrong_importtype' => '$1不可用于命名空间"$2"下的页面。',
	'smw_no_importelement' => '不可导入元素"$1"。',
	'smw_parseerror' => '输入的值无法理解。',
	'smw_notitle' => '"$1"不得被用做此维基的页面名称。',
	'smw_wrong_namespace' => '此处只允许命名空间"$1"中的页面。',
	...
	'smw_infinite_unit' => '数字转换为单位"$1"后过大。',
	'smw_novalues' => '未设置数值。',
	'smw_unsupportedprefix' => '不支持数字（"$1"）前缀',
...
结果可能与预料的不同。',
	...
	'smw_overprintoutlimit' => '查询包含过多显示请求。',
	'smw_badprintout' => '查询中的一些输出状态异常。',
	'smw_badtitle' => '"$1"是无效页面标题。',
	...
	'smw_devel_warning' => '此功能正在开发中，可能无法完全正常使用。请在使用此功能前做好备份。',
...
生成可浏览的RDF。',
	...
	'tooltip-purge' => '点击这里更新页面的所有查询和模板',
	'smw_purge' => '更新',
	'types' => '类型',
...
输入页面和属性。',
	...
	'smw_smwadmin_settingup' => '设置Semantic MediaWiki存储',
...
如果這個問題在一段時間後仍未解決，請向網站管理員請求令該概念可用。',
	...
	'smw_iq_nojs' => '使用允許 JavaScript 的瀏覽器顯示此元素',
	'smw_iq_altresults' => '直接瀏覽結果列表。',
	'smw_unknown_importns' => '名子空間「$1」不允許匯入函數。',
...
結果可能與預料的不同。',
	...
	'smw_overprintoutlimit' => '查詢包含過多顯示請求。',
	'smw_badprintout' => '查詢中的一些輸出狀態異常。',
	'smw_badtitle' => '「$1」是無效頁面標題。',
	...
	'smw_devel_warning' => '此功能正在開發中，可能無法完全正常使用。請在使用此功能前做好備份。',
...
輸入頁面和屬性。',
	...
	'smw_smwadmin_settingup' => '設定 Semantic MediaWiki 儲存',
