...
$messages['arz'] = array(
	...
	'smw_paramdesc_sep' => 'فاصل القيم',
	'smw_paramdesc_template' => 'اسم القالب لعرض الخرج به',
	'smw_paramdesc_columns' => 'رقم الأعمده لعرض النتائج بها (افتراضيا 3)',
	'smw_paramdesc_embedformat' => 'وسم HTML المستخدم لتعريف الترويسة',
	'smw_paramdesc_embedonly' => 'لا تظهر الترويسات',
	'smw_paramdesc_rsstitle' => 'النص المستخدم كعنوان للتغذية',
	'smw_paramdesc_rssdescription' => 'النص المستخدم لوصف التغذية',
	...
	'smw_lonely_unit' => 'لم يتم العثور على رقم قبل الرمز "$1".',
	'smw_bad_latlong' => 'خطوط الطول والعرض يجب أن تعطى مره واحده فقط، وإحداثيات صحيحه.',
	'smw_abb_north' => 'شمال',
	'smw_abb_east' => 'شرق',
	'smw_abb_south' => 'جنوب',
	'smw_abb_west' => 'غرب',
...
Si el problema persiste después de pasado algún tiempo, solicita al administrador de tu sitio que haga este concepto disponible.',
	...
	'smw_paramdesc_columns' => 'El número de columnas donde se muestran los resultados (el predeterminado es 3)',
...
$messages['it'] = array(
	...
	'smw_paramdesc_columns' => 'Il numero di colonne in cui ordinare la visualizzazione dei risultati (valore predefinito: 3)',
...
$messages['lb'] = array(
	...
	'smw_paramdesc_columns' => "D?zuel vu Colonnen an deenen d'Resultater vun dr Sich gewise ginn (Standard ass 3)",
	...
	'smw_bad_latlong' => "D'Längt an d'Breet däerfen nëmmen eemol ugi ginn an dat mat valabele Koordinaten.",
	'smw_abb_north' => 'N',
	'smw_abb_east' => 'O',
	'smw_abb_south' => 'S',
	'smw_abb_west' => 'W',
...
Ако проблемот не исчезне по извесно време, побарајте од вашиот администратор да го овозможи тој концепт.',
	...
	'smw_paramdesc_rsstitle' => 'Текстот што ќе се користи како наслов на напојувањето',
	'smw_paramdesc_rssdescription' => 'Текстот што ќе се користи како опис на напојувањето',
	...
	'smw_lonely_unit' => 'Нема пронајдено број пред знакот „$1“.',
	'smw_bad_latlong' => 'Географската ширина и должина мора да бидат наведени само еднаш, и тоа со важечки координати.',
	'smw_abb_north' => 'С',
	'smw_abb_east' => 'И',
	'smw_abb_south' => 'Ј',
	'smw_abb_west' => 'З',
...
Ако проблем не нестане за неко време, затражите од администратора сајта да учини овај концепт доступним.',
	...
	'smw_paramdesc_columns' => 'Број колона у којима ће се приказати резултати (предодређено 3)',
...
Сервиз неће регистровати викије који нису јавно доступни, а једино ће сачувати јавно доступне информације.',
...
Ako problem ne nestane za neko vreme, zatražite od administratora sajta da učini ovaj koncept dostupnim.',
	...
	'smw_paramdesc_columns' => 'Broj kolona u kojima će se prikazati rezultati (predodređeno 3)',
...
$messages['tr'] = array(
	...
	'smw_abb_south' => 'G',
	'smw_abb_west' => 'B',
	'smw_label_latitude' => 'Enlem:',
	'smw_label_longitude' => 'Boylam:',
