...
$messages['ja'] = array(
	...
	'smw_iq_disabled' => '意味クエリーはこのウィキでは無効になっています。',
	...
	'smw_purge' => '更新',
	'ontologyimport' => 'オントロジーをインポート',
	'smw_oi_docu' => 'この特別ページを使うとオントロジーをインポートできます。オントロジーは、<a href="http://semantic-mediawiki.org/wiki/Help:Ontology_import">オントロジーのインポートについてのヘルプページ</a>で定められた形式に則っている必要があります。',
	'smw_oi_action' => 'インポート',
	'smw_oi_return' => '<a href="$1">Special:OntologyImport</a> に戻る。',
	'smw_oi_noontology' => 'インポートすべきオントロジーが存在しないか、読み込みができませんでした。',
	...
	'smw_smwadmin_updatestarted' => '意味データを最新の状態とするための新しい更新プロセスが開始しました。格納済みのデータはすべて必要に応じて再構築または修復されます。この特別ページで更新の状況を追うことができます。',
