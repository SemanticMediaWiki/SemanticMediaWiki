...
Зрабіце рэзэрвовую копію Вашы зьвестак перад яе выкарыстаньнем захавайце.',
	...
	'smw_exportrdf_docu' => '<p>Гэта старонка дазваляе Вам атрымліваць зьвесткі са старонкі ў фармаце RDF.
Каб экспартаваць старонкі, увядзіце іх назвы ніжэй у тэкставым полі, па адной назьве на радок.</p>',
...
Колькасьць няслушных уласьцівасьцяў пададзеная ў дужках.',
	...
	'smw_uri_doc' => '<p>Пераўтваральнік URI ажыцьцяўляе <a href="http://www.w3.org/2001/tag/issues.html#httpRange-14">пошук W3C TAG у httpRange-14</a>.
Гэта забясьпечвае ўпэўненасьць, што людзі не заходзяць на сайты.</p>',
	...
	'smw_sbv_docu' => '<p>Шукаць усе старонкі, якія ўтрымліваюць пададзеную ўласьцівасьць і значэньне.</p>',
	'smw_sbv_noproperty' => '<p>Увядзіце ўласьцівасьць.</p>',
	'smw_sbv_novalue' => '<p>Увядзіце значэньне для ўласьцівасьці, ці паглядзіце ўсе значэньні ўласьцівасьцяў для «$1».</p>',
...
Wänn s Probläm imfall noch eme Rung nit verschwindet, no bitt Dyy Syteverwalter, des Konzäpt megli z mache.',
	...
	'smw_sbv_docu' => '<p>Diese Spezialsyte findet alli Syte, wu e bstimmte Wärt hän fir d Eigeschaft, wu aagee woren isch.</p>',
	'smw_sbv_noproperty' => '<p>Bitte e Eigeschaft yygee</p>',
	'smw_sbv_novalue' => '<p>Bitte dr gwinscht Wärt yygee oder alli Wärte fir d Eigeschaft $1 aaluege.</p>',
...
müjjelesch, un dä Aandeil ($1) es dröm us dä Frooch eruß jenumme woode.',
	...
	'smw_exportrdf_docu' => '<p>Hee di Sigg määd et müjjelesch, Daate vun en Sigg em <i lang="en">RDF</i>-Fommaat ze krijje. Öm Sigge ze Expoteere, doon dänne ier Tittele, jeeder_ein en en Reih fö sesch, onge en dat Täx-Feld erin schriive.</p>',
...
(-: un sorresch esu doför, dat uß Minsche kei Websigge wääde :-)</p>',
	...
	'smw_sbv_docu' => '<p>Donn noh all dä Sigge söhke, die beshtemmpte Eijeschaff han, un medd_ennem beshtemmpte Wäät för se.</p>',
	'smw_sbv_noproperty' => '<p>Donn en Eijeschaff aanjevve.</p>',
	'smw_sbv_novalue' => '<p>Donn ene jöltijje Wäät för di Eijeschaff aanjevve, udder donn Der all de müjjelesche Wääte för „$1“ aanlooere.</p>',
...
(Weil nur winnisch dovun do sin, dom_mer de ähnlesche Wääte metzeije)',
	...
	'smw_pp_docu' => 'Söhk noh all dä Wääte, di en beshtemmpte Eijeschaff för de aanjejovve Sigg hät. Donn en Sigg aanjevve und donn en Eijeschaff aanjevve.',
...
$messages['oc'] = array(
	...
	'smw_exportrdf_docu' => "<p>Sus aquesta pagina, de partidas del contengut d'un article pòdon èsser exportadas dins lo format RDF. Picatz lo nom de las paginas desiradas dins la bóstia de tèxte çaijós, <i>un nom per linha </i>.</p>",
