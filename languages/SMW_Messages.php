...
The ontologies have to follow a certain format, specified at the <a href="http://wiki.ontoworld.org/index.php/Help:Ontology_import">ontology import help page</a>.',
...
$messages['ar'] = array(
	...
	'smw_no_importelement'        => 'غير متاح للاستيراد “$1” العنصر.',
	...
	'smw_noboolean'               => 'لا تعتبر قيمة منطقية (صحيح/خطأ) “$1”',
	'smw_true_words'              => ' صحيح ،ص ، نعم ، ن ',
	'smw_false_words'             => 'ليس صحيحا،ص،لا',
	'smw_nofloat'                 => 'ليس عددا “$1”.',
	'smw_infinite'                => '{{SITENAME}} ليست مدعومة في “$1” أرقام كبيرة حسب',
	'smw_infinite_unit'           => '{{SITENAME}} أسفر ذلك عدد كبير جدا بالنسبة إلى“$1” تحويلها إلى وحدة.',
	'smw_unsupportedprefix'       => 'غير مدعوم (“$1”) البادئات لأرقام.',
	'smw_unsupportedunit'         => 'غير مدعوم “$1”  وحدة لتحويل وحدة.',
	'smw_lonely_unit'             => '“$1” لا توجد أي عدد قبل الرمز.',
	...
	'smw_nodatetime'              => 'لم يفهم (الدعم للتواريخ مازال تجريبيا). “$1”  تاريخ',
	'smw_toomanyclosing'          => 'في الاستعلام“$1”  يبدو أن هناك الكثير من الحوادث.',
	'smw_noclosingbrackets'       => '“]]” في بحثك لم تكن مغلقة باستخدام “[&#x005B;” بعض استخدام',
	'smw_misplacedsymbol'         => 'تم استخدامه في مكان حيث أنها ليست مفيدة “$1”   الرمز.',
	'smw_unexpectedpart'          => 'للاستفسار لا يفهم.
النتائج قد لا تكون كما هو متوقع “$1”  هذا الجزء',
	...
	'smw_valuesubquery'           => '“$1” الاستفسارات الفرعية لا يدعم قيم خاصية.',
	'smw_overprintoutlimit'       => 'هذا الاستعلام تحتوي على عدد كبير جدا من طلبات العرض على الشاشة.',
	'smw_badprintout'             => 'بعض المطبوعات في بيان الاستعلام لم تتشكل بصورة صحيحة.',
	'smw_badtitle'                => 'ليس عنوان صفحة صحيح. “$1” عذرا، ولكن',
	'smw_badqueryatom'            => 'لم يكن يفهم“[&#x005B;&hellip;]]” أجزاء من',
	'smw_propvalueproblem'        => 'لم يكن يفهم“$1” قيمة الخاصية.',
	'smw_nodisjunctions'          => 'المفارق في استعلامات ليست مدعومة في هذا الويكي وجزء من الاستعلام رفض $1.',
	'smw_querytoolarge'           => 'هذه شروط استفسار لا يمكن اعتباره نتيجة لقيود الويكي في الحجم أو عمق استفسار $1.',
...
يولد آر دي إف قابل للتصفح.',
	...
	'smw_propertylackstype'       => '("$1" لا نوع الخاصية ليست محددة (على افتراض نوع.',
	'smw_propertyhardlyused'      => 'هذه الخاصية لا يكاد يستخدم داخل يكي!',
	'unusedproperties'            => 'خصائص غير مستخدمة',
	'smw_unusedproperties_docu'   => 'الخصائص التالية تظهر على الرغم من عدم وجود صفحة أخرى يستفيد منها.',
	'smw_unusedproperty_template' => '$1 من نوع $2',
	'wantedproperties'            => 'خصائص مطلوبة',
	'smw_wantedproperties_docu'   => 'التالية تستخدم في ويكي ولكن ليس لديها حتى الآن صفحة لوصفها الخصائص.',
	'smw_wantedproperty_template' => '$1 ($2 الاستعمالات)',
	'tooltip-purge'               => 'اضغط هنا لتحديث كافة الاستفسارات والقوالب على هذه الصفحة',
	'smw_purge'                   => 'تحديث',
	'ontologyimport'              => 'استيراد أنتولوجي',
	'smw_oi_docu'                 => 'استيراد صفحة المساعدة أنتولوجي <a href="http://wiki.ontoworld.org/index.php/Help:Ontology_import">  هذه صفحة خاصة تسمح باستيراد أنتولوجي.
فان أنتولوجي يجب اتباع شكل معين ، كما هو محدد في</a>.',
	'smw_oi_action'               => 'استيراد',
	'smw_oi_return'               => '<a href="$1">Special:OntologyImport</a> العودة إلى',
	...
	'smw_oi_selectall'            => 'اختر أو احذف جميع البيانات',
	'smw_oi_statementsabout'      => 'بيانات حول',
	'smw_oi_mapto'                => 'خريطه لكيان',
	'smw_oi_comment'              => 'يضاف النص التالي:',
	'smw_oi_thisissubcategoryof'  => 'فئة فرعية ل',
	'smw_oi_thishascategory'      => 'هي جزء من',
	'smw_oi_importedfromontology' => 'الاستيراد من الأنتولوجيا',
	'types'                       => 'أنواع',
	'smw_types_docu'              => 'فيما يلى قائمة من جميع أنواع البيانات التي يمكن أن تسند الى الخصائص. كل البيانات له صفحة فيها معلومات إضافية يمكن توفيرها.',
	'smw_typeunits'               => '$2 : “$1” وحدات القياس من النوع',
	'semanticstatistics'          => 'إحصاءات دلالية',
	'smw_semstats_text'           => '<a href="$7"> قائمة المطلوبين الخصائص </a> الخصائص التي لا تزال تفتقر إلى صفحة موجودة على <a href="$6"> معطله</a> <b>$5</b> . بعض من الخصائص الموجودة قد تكون<b>$4</b> خواص لها صفحة خاصة بها، والمقصود هو نوع البيانات المحدد ل </a> مختلفة  <a href="$3"> الخصائص <b>$1</b> خصائص القيم مجموعة <b>$2</b> يتضمن هذا يكي',
...
عدد الخصائص غير صحيح يرد في الاقواس.',
	...
	'smw_add_sortcondition'       => '[إضافة شرط الترتيب]',
	'smw_ask_hidequery'           => 'إخفاء الاستعلام',
	'smw_ask_help'                => 'سؤال مساعدة',
	'smw_ask_queryhead'           => 'استفسار',
	...
	'smw_sbv_noproperty'          => '<p>الرجاء إدخال خاصية.</p>',
	'smw_sbv_novalue'             => '<p> “$1.” الرجاء إدخال قيمة الخصائص، أو اعرض كل قيم الخصائص </p>',
	'smw_sbv_displayresult'       => '“$2”  مع قيمة “$1” قائمة بجميع الصفحات التي لديه الخصائص',
	'smw_sbv_property'            => 'خاصية',
	'smw_sbv_value'               => 'القيمة',
	'smw_sbv_submit'              => 'إيجاد نتائج',
	'browse'                      => 'استعرض يكي',
	'smw_browse_article'          => 'أدخل اسم الصفحة لتبدأ التصفح.',
	'smw_browse_go'               => 'اذهب',
	'pageproperty'                => 'بحث عن خصائص الصفحة',
	'smw_pp_docu'                 => 'البحث عن جميع قيم سمة على صفحة معينة.
الرجاء إدخال كل صفحة وميزة.',
	'smw_pp_from'                 => 'من صفحة',
	'smw_pp_type'                 => 'الخاصية',
...
Ta en kopi av dataene før du bruker den.',
	...
	'smw_attributearticlecount'   => '<p>Viser $1 sider som bruker denne egenskapen.</p>',
...
Ontologiene må følge et visst format, spesifisert på <a href="http://wiki.ontoworld.org/index.php/Help:Ontology_import">hjelpesiden for ontologiimport</a>.',
	'smw_oi_action'               => 'Importer',
...
$messages['oc'] = array(
	...
	'smw_devel_warning'           => "Aquesta foncion es encara en desvolopament e benlèu es pas encara operacionala. Pòt èsser judiciós de far una salvagarda del contengut del wiki abans tota utilizacion d'aquesta foncion.",
	...
	'smw_add_sortcondition'       => '[Ajusta las condicions de triada]',
...
Výsledky nemusia byť podľa očakávaní.',
	...
	'smw_attributearticlecount'   => '<p>Zobrazuje sa $1 stránok, ktoré používajú túto vlastnosť.</p>',
...
$messages['zh-cn'] = array(
	...
	'smw_attributearticlecount'   => '<p>以此性质显示$1页面.</p>',
	'exportrdf'                   => '输出页面至RDF 。',
	...
	'smw_oi_docu'                 => '此特殊页可用以输入知识本体(ontology)，此知识本体(ontology)必须依循特定的格式，此特定格式在<a href="http://wiki.ontoworld.org/index.php/Help:Ontology_import">知识本体(ontology)的导入求助页面。</a>',
	'smw_oi_action'               => '输入',
...
$messages['zh-tw'] = array(
	...
	'smw_attributearticlecount'   => '<p>以此性質顯示$1頁面.</p>',
	'exportrdf'                   => '輸出頁面至RDF 。',
	...
	'smw_oi_docu'                 => '此特殊頁可用以輸入知識本體(ontology)，此知識本體(ontology)必須依循特定的格式，此特定格式在<a href="http://wiki.ontoworld.org/index.php/Help:Ontology_import">知識本體(ontology)的匯入求助頁面。</a>',
	'smw_oi_action'               => '輸入',
