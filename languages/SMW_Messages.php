...
$messages['be-tarask'] = array(
	...
	'smw-paramdesc-table-class' => 'Дадатковая кляса CSS для набору ў табліцы',
	...
	'smw-smwdoc-description' => 'Адлюстроўвае табліцу з усімі парамэтрамі, якія могуць ужывацца для абранага фармату выніку разам з дапомнымі значэньнямі і апісаньнямі.',
	'smw-smwdoc-par-format' => 'Выніковы фармат для паказу дакумэнтацыі па парамэтрах.',
	'smw-paramdesc-sort' => 'Уласьцівасьць для сартаваньня чаргі паводле',
...
Гэта забясьпечвае ўпэўненасьць, што людзі не заходзяць на сайты.',
	...
	'smw_qc_show_addnal_opts' => 'Паказаць болей наладак',
	'smw_qc_hide_addnal_opts' => 'Паказаць меней наладак',
	'smw_qc_otheropt' => 'Іншыя налады',
	'smw_qc_intro' => 'Уступ:',
	'smw_qc_outro' => 'Заканчэньне:',
	'smw_qc_default' => 'Дапомна:',
	'smw_qc_formatopt' => 'Опцыі фармату',
...
Назвам(<strong>[[Нямеччына]]</strong>) і Прасторам назваў (<strong>[[{{ns:help}}:+]]</strong>)',
	...
	'smw_qui_noquery' => 'Не абраны запыт',
	'smw_qui_invalidprop' => '"$1" не зьяўляецца слушнай уласьцівасьцю',
	'smw_qui_invalidformat' => 'Абранага фармату "$1" для дадзенай вікі не існуе',
...
Falls sich das Problem nicht in angemessener Zeit von selbst erledigt, bitte deinen Websiteadministrator, die Daten dieses Konzepts zu aktualisieren.',
	...
	'smw_true_words' => 'wahr,w,ja,j,true',
	'smw_false_words' => 'falsch,f,nein,n,false',
