...
Гэта забясьпечвае ўпэўненасьць, што людзі не заходзяць на сайты.',
	...
	'smw_sbv_noproperty' => 'Увядзіце ўласьцівасьць.',
...
Vlastnosti, kterým stále chybí stránka se nacházejí na <a href="$7">seznamu požadovaných vlastností</a>.',
	...
	'smw_sbv_noproperty' => 'Vložte prosím vlastnost.',
...
Falls das Problem nicht nach einiger Zeit verschwindet, bitte deinen Seitenverwalter, dieses Konzept zu ermöglichen.',
	...
	'smw_sbv_noproperty' => 'Bitte den Namen eines Attributs eingeben',
...
Ĉiu datentipo havas paĝon kie plua informo povas esti aldonita.',
	...
	'smw_sbv_noproperty' => 'Bonvolu enigi econ.',
...
$messages['es'] = array(
	...
	'smw_sbv_noproperty' => 'Por favor introduzca un atributo.',
...
Les propriétés qui n’ont pas encore de page se trouvent dans la [[Special:WantedProperties|liste des propriétés demandées]].",
	...
	'smw_sbv_noproperty' => 'Veuillez entrer un attribut.',
...
O númeor de propiedades incorrectas está dado entre parénteses.',
	...
	'smw_sbv_noproperty' => 'Por favor, insira unha propiedade.',
...
Wänn s Probläm imfall noch eme Rung nit verschwindet, no bitt Dyy Syteverwalter, des Konzäpt megli z mache.',
	...
	'smw_sbv_noproperty' => 'Bitte e Eigeschaft yygee',
...
מספר המאפיינים שאינם נכונים נתון בסוגריים.',
	...
	'smw_sbv_noproperty' => 'כתבו מאפיין.',
...
Ličba wopačnych kajkosćow so w wuzhibowanych spinkach podawa.',
	...
	'smw_sbv_noproperty' => 'Zapodaj prošu kajkosć.',
...
Illo assecura que le humanos non se transforma in sitos web.',
	...
	'smw_sbv_noproperty' => 'Entra un proprietate.',
...
Le proprietà che ancora non hanno una pagina si possono trovare nell'[[Special:WantedProperties|elenco delle proprietà senza descrizione]].",
	...
	'smw_sbv_docu' => 'Cerca tutte le pagine che hanno propriet&agrave; e valore specificati.',
	'smw_sbv_noproperty' => 'Per favore inserire una propriet&agrave;.',
	'smw_sbv_novalue' => 'Per favore inserire un valore valido per la propriet&agrave;, o visualizzare tutti i valori di propriet&agrave; per “$1.”',
...
$messages['ja'] = array(
	...
	'smw_sbv_noproperty' => 'プロパティを入力してください。',
...
Cacahé sifat sing ora bener iki diwènèhaké antara tandha kurung.',
	...
	'smw_sbv_noproperty' => 'Mangga lebokna sawijining sifat.',
...
$messages['km'] = array(
	...
	'smw_sbv_noproperty' => 'បញ្ចូល​លក្ខណៈសម្បត្តិ​។',
...
(-: un sorresch esu doför, dat uß Minsche kei Websigge wääde :-)',
	...
	'smw_sbv_noproperty' => 'Donn en Eijeschaff aanjevve.',
...
चुकीच्या गुणधर्मांची संख्या कंसात दिलेली आहे.',
	...
	'smw_sbv_noproperty' => 'कृपया एक गुणधर्म द्या.',
...
Eigenschappen waar nog geen pagina voor is zijn te vinden op de [[Special:WantedProperties|lijst met gewenste eigenschappen]].",
	...
	'smw_sbv_noproperty' => 'Voer een eigenschap in.',
...
Han syter for at menneske ikkje vert til nettsider.",
	...
	'smw_sbv_noproperty' => 'Skriv inn ein eigenskap.',
...
Antallet ukorrekte egenskaper gis i parentes.',
	...
	'smw_sbv_noproperty' => 'Skriv inn en egenskap.',
...
Las proprietats qu'an pas encara de pagina se tròban dins la [[Special:WantedProperties|lista de las proprietats demandadas]].",
	...
	'smw_sbv_noproperty' => 'Picatz un atribut.',
...
$messages['pl'] = array(
	...
	'smw_sbv_noproperty' => 'Wpisz atrybut.',
...
O número de propriedades incorrectas é dada entre parênteses rectos.',
	...
	'smw_sbv_noproperty' => 'Por favor, introduza uma propriedade.',
...
$messages['ru'] = array(
	...
	'smw_sbv_noproperty' => 'Укажите свойство.',
...
Vlastnosti, ktorým stále chýba stránka sa nachádzajú na [[Special:WantedProperties|zozname žiadaných vlastností]].",
	...
	'smw_sbv_noproperty' => 'Nebol poskytnutý atribút. Prosím, poskytnite ho vo formulári.',
...
Број погрешно дефинисаних особина је дат у заградама.',
	...
	'smw_sbv_noproperty' => 'Унеси особину.',
...
Antalet felaktiga egenskaper visas inom parenteserna.',
	...
	'smw_sbv_noproperty' => 'Skriv in en egenskap.',
...
Pinag-iingatan nitong huwag maging mga sityo ng web (websayt) ang mga tao.',
	...
	'smw_sbv_noproperty' => 'Maglagay/magpasok ng isang pag-aari.',
...
Số thuộc tính không đúng được ghi trong ngoặc đơn.',
	...
	'smw_sbv_noproperty' => 'Xin nhập một thuộc tính.',
...
$messages['vo'] = array(
	...
	'smw_sbv_noproperty' => 'Penolös patöfi.',
