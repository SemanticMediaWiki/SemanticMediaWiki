...
use SMW\MediaWiki\Hooks\InfoAction;
...
/**
 * @covers \SMW\MediaWiki\Hooks\InfoAction
 *
 *
 * @group SMW
 * @group SMWExtension
 ...
 * @author misdre
 */
class InfoActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'\SMW\MediaWiki\Hooks\InfoAction',
			new InfoAction( $outputPage, $parserOutput, $pageInfo )
		);
	}
	...
	public function testProcess( $parameters, $expected ) {
		...
		$instance = new InfoAction( $outputPage, $parserOutput, $pageInfo );
