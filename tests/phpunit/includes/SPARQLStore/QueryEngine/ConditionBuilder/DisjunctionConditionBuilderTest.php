...
/**
 * @covers \SMW\SPARQLStore\QueryEngine\ConditionBuilder\DisjunctionConditionBuilder
 *
 * @group SMW
 * @group SMWExtension
 *
 ...
 * @author mwjames
 */
class DisjunctionConditionBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			...
			new DisjunctionConditionBuilder( $compoundConditionBuilder )
		);
	}
	...
	public function testCanBuildConditionFor() {
		...
		$instance = new DisjunctionConditionBuilder( $compoundConditionBuilder );
	...
	public function testConjunctionCondition( $description, $orderByProperty, $sortkeys, $expectedConditionType, $expectedConditionString ) {
		...
		$instance = new DisjunctionConditionBuilder();
