...
- [6.x to 7.0.0](https://github.com/SemanticMediaWiki/SemanticMediaWiki/blob/master/docs/migration/7.0.md) contains the detailed migration tables for the 7.0 release
