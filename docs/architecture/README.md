...
- Development happens against the master branch (see also the [release process](../RELEASE-PROCESS.md)) and will be release according the the available release plan, backports should be cherry-picked and merged into the targeted branch
