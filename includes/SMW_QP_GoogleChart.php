...
class SMWGoogleBarResultPrinter extends SMWResultPrinter {
	...
	protected function getResultText($res, $outputmode) {
		...
		return 	'<img src="http://chart.apis.google.com/chart?cht=bhs&chbh=' . $barwidth . ',' . $bardistance . '&chs=' . $this->m_width . 'x' . $height . '&chds=0,' . $max . '&chd=t:' . $t . '&chxt=y&chxl=0:|' . $n . '" />';
...
class SMWGooglePieResultPrinter extends SMWResultPrinter {
	...
	protected function getResultText($res, $outputmode) {
		...
		return 	'<img src="http://chart.apis.google.com/chart?cht=p3&chs=' . $this->m_width . 'x' . $this->m_height . '&chds=0,' . $max . '&chd=t:' . $t . '&chl=' . $n . '" />';
