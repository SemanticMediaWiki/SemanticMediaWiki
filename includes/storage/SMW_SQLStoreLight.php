...
///// Helper methods, mostly protected /////
	...
	public static function getTypeSignature( $typeid ) {
		if ( !array_key_exists( $typeid, SMWSQLStoreLight::$type_signatures ) ) {
			$dv = SMWDataValueFactory::newTypeIDValue( $typeid );
			SMWSQLStoreLight::$type_signatures[$typeid] = array( $dv->getSignature(), $dv->getValueIndex(), $dv->getLabelIndex() );
		}
		return SMWSQLStoreLight::$type_signatures[$typeid];
	}
